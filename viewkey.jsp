...
<%
 ...
 Connection con=null;
	...
	String sql="select filename,subject,date,file.key from file where username='"+uname+"'";
            ...
            <div align="center" style="background-color: #FFF2EF"> 
              <table border="1" width="500" height="" cellpadding="5" cellspacing="5">
                ...
                <tr> 
                  ...
                  <td  class="paragraping"><font color="#FF0000"> <strong>Key</strong></font></td>
                </tr>
                <%
				 while(rs.next())
				 {
                ...
                <tr> 
                  ...
                  <td  class="paragraping"><font size="2"> <strong><%=key%></strong></font></td>
                </tr>
                <%}%>
              </table>
            </div>
